...
# AgroGuard: Smart Greenhouse Monitoring & Control System 🌱

**AgroGuard** is an open-source, ESP32-based solution designed for precision agriculture and automated greenhouse management. It integrates environmental sensors with relay controls to provide real-time monitoring and automation for irrigation and ventilation systems.
